...
<style>
body{
  background: linear-gradient(mistyrose, forestgreen, #808000);
...
<div class="container">
  ...
  <center><h1>Give Your Review <span style="color:#800000;"><?php echo $_SESSION['username']; ?></span></h1>
...
?>
  ...
  <form class="form-horizontal" method="post" action="send_comment.php?food_name=<?php echo $food_name; ?>&food_id=<?php echo $food_id; ?>">
    <div class="form-group">
      <div class="col-sm-10">          
        <textarea name="msg" class="form-control" placeholder="Type your comment here..."></textarea>
      </div>  
      <div class="col-sm-2">
