...
<div class="section2">
  <h2>Ongoing Orders</h2>
      ...
      <tr>
       ...
       <?php
          $i=0;
          $sql10 = mysqli_query($db, "SELECT * FROM order2 WHERE status=1 AND order_status='Preparing' AND seller_name='$seller_name'");
         while($res=mysqli_fetch_assoc($sql10))
         {
           ...
           ?>
              ...
              <tr>
                ...
                <th><button type="submit" onclick="myFunction()">Dilivered</button></th>
   ...
   <script>
  function myFunction(){
    window.location.href = "on_the_way.php?id=<?php echo $order_id; ?>";
  }
  </script>
