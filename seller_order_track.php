...
$query2 = "SELECT * FROM seller WHERE username='$username'";
 ...
 <?php 
    ...
    {
      $order_id=$_GET['id'];
      $sql_update=mysqli_query($db, "UPDATE order2 SET status=1 WHERE id='$order_id'");
    }
 ?>
...
<div class="section2">
  <h2>Your Orders</h2>
      ...
      <tr>
       ...
       <?php
          $i=0;
          $sql10 = mysqli_query($db, "SELECT * FROM order2 WHERE status=1 AND order_status='Ordered' AND seller_name='$seller_name'");
         while($res=mysqli_fetch_assoc($sql10))
         {
           ...
           ?>
              ...
              <tr>
                ...
                <th><a   href="order_confirm.php?id=<?php echo $order_id; ?>"><i class="fa fa-check"></i></a></th>
                <th><a  href="order_delete.php?id=<?php echo $order_id; ?>"><i class="fa fa-close"></i></a></th>
